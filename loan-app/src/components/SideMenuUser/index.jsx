...
function SideMenuUser() {
  ...
  return (
    ...
    <div className={styles.resMenu}>
       <p style={{cursor:'pointer'}} onClick={()=> routeFunc('/user/view-loan')} className={`${styles.sideItemsText}`}>View Loans</p>
       <p style={{cursor:'pointer'}}   onClick={()=> routeFunc('/user/apply-loan')} className={`${styles.sideItemsText}`}>Apply Loan</p>
       <p style={{cursor:'pointer'}} onClick={()=> routeFunc('/user/view-items')} className={`${styles.sideItemsText}`}>View Items</p>
    </div>
    </>
  )
}
